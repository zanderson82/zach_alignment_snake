...
rule filter_clair3_vcf:
    ...
    shell:
    """
    bcftools view -i '"FILTER="PASS"' -o {output.clair3_phased_filtered_vcf}
    """
...
rule run_vep:
    ...
    shell:
        ...
        --pick_allele --use_given_ref --fork {THREADS} -i {input.clair3_phased_vcf} -o {output.vep_vcf} --canonical --symbol --numbers \
